    ...
    public class TicketsController : ControllerBase
    {
        ...
        public async Task<ActionResult> Get()
        {
            try
            {
                ...
                var dobjects = _mapper.Map<IEnumerable<TicketDto>>(entities);
                return Ok(dobjects);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(long id)
        {
            try
            {
                ...
                var dobject = _mapper.Map<TicketDto>(entity);
                return Ok(dobject);
            }
            catch (Exception ex)
            {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Update(long id, [FromBody] TicketDto ticket)
        {
            try
            {
                if (ticket == null)
